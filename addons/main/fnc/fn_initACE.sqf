...
private _action = ["KPR_Check", localize "STR_KPR_ACTION_CHECKRANK", "\z\KP_Ranks\addons\main\kplogo_ca.paa", {[true] call KPR_fnc_applyRank;}, {!KPR_autoMode || KPR_levelSystem}] call ace_interact_menu_fnc_createAction;
[(typeOf player), 1, ["ACE_SelfActions", "ACE_Equipment"], _action] call ace_interact_menu_fnc_addActionToClass;

// KP Ranks administration category for self interactions
_action = ["KPR_Admin", "Ranks Admin", "\z\KP_Ranks\addons\main\kplogo_ca.paa", {}, {KPR_isAdmin}] call ace_interact_menu_fnc_createAction;
